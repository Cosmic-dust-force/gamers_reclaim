  ...
  return (
    <div className="flex flex-col content-center text-lg">
      ...
      <p className="font-raj text-center font-thin">
        Gamer's Reclaim accepts and resells refurbished video game accessories, making them accessible to the public.
      </p>
      <p className="font-raj text-center font-thin">
      ...
      <div className="flex place-content-evenly flex-wrap lg:flex-nowrap">
        <div className="flex flex-col items-center p-4">
          ...
          <p className="text-base font-thin text-center"> We securely accept and process payments.</p>
        </div>
        ...
        <div className="flex flex-col items-center p-4">
          ...
          <p className="text-base font-thin text-center">We give you the convenience of paying any way you like!</p>
        </div>
        ...
        <div className="flex flex-col items-center p-4">
          ...
          <p className="text-base font-thin text-center">We offer fast reliable shipping!</p>
